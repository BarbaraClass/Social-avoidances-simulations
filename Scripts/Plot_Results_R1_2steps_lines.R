...
jpeg("Plots/Metrics_2steps/Modularity_lines.jpeg",width=800,height=800,quality=100)
...
jpeg("Plots/Metrics_2steps/Naffiliates_lines.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
jpeg("Plots/Metrics_2steps/Navoidances_lines.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
jpeg("Plots/Metrics_2steps/ClusteringCoeff_lines.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
jpeg("Plots/Metrics_2steps/CVDegree_lines.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
