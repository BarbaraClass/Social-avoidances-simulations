...
jpeg("Plots/Metrics_2steps/Modularity_lines_Pn.jpeg",width=800,height=800,quality=100)
...
jpeg("Plots/Metrics_2steps/Naffiliates_lines_Pn.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
jpeg("Plots/Metrics_2steps/Navoidances_lines_Pn.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
jpeg("Plots/Metrics_2steps/ClusteringCoeff_lines_Pn.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
...
plot(CCpos$pn.in[1:6],CCpos$CCpos[1:6], ylim=c(0.2,0.6),col=cols[2],lwd=2,
     xlab="Pn", ylab="Clustering coefficient",type="l",main=list("Pr=0.001",cex=2,font=1),cex.axis=1.5,cex.lab=2)
par(new=TRUE)
plot(CCpos$pn.in[7:12],CCpos$CCpos[7:12], ylim=c(0.2,0.6),col=cols[4],lwd=2,
     xaxt="n",yaxt="n",xlab="", ylab="",type="l")
par(new=TRUE)
plot(CCpos$pn.in[13:18],CCpos$CCpos[13:18], ylim=c(0.2,0.6),col=cols[6],lwd=2,
     xaxt="n",yaxt="n",xlab="", ylab="",type="l")
par(new=TRUE)
plot(CCpos$pn.in[19:24],CCpos$CCpos[19:24], ylim=c(0.2,0.6),col=cols[8],lwd=2,
     xaxt="n",yaxt="n",xlab="", ylab="",type="l")
...
jpeg("Plots/Metrics_2steps/CVDegree_lines_Pn.jpeg",width=800,height=800,quality=100)
par(mfrow=c(1,3),mar=c(5,5,5,2))
